...
import { ModalTelegramActions, ModalTelegramProps } from './types';
// import formValidate from 'utils/form-validate';

const cx = classNames.bind(styles);

const ModalTelegram = forwardRef<ModalTelegramActions, ModalTelegramProps>(
    ({ description, onSuccessPress }: ModalTelegramProps, ref) => {
