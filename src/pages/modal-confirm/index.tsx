...
import { ModalConfirmActions, ModalConfirmProps } from './types';

const cx = classNames.bind(styles);
const ModalConfirm = forwardRef<ModalConfirmActions, ModalConfirmProps>(
    ({ description, onSuccessPress }: ModalConfirmProps, ref) => {
